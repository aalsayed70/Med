    ...
    <div className="flex flex-row-reverse justify-center space-x-4 space-x-reverse">
      {[
        ...
        <label key={index} className="flex-1">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-purple-600 via-puple-400 to-pink-400 text-white font-bold py-4 px-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-purple-500 focus:ring-opacity-50 relative overflow-hidden group"
          >
