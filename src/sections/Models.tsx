...
export const Models = () => {
  ...
  <div className="mb-6 w-60 h-60 bg-gradient-to-br from-blue-400 to-pink-500 rounded-full shadow-2xl p-4 flex justify-center items-center relative">
    ...
    />
        ...
        <div className="bg-gradient-to-br from-pink-400 to-purple-500 text-center text-white max-w-3xl mx-auto px-6 py-8 rounded-xl shadow-2xl border-2 border-pink-300 relative z-10 mb-6 overflow-hidden">
